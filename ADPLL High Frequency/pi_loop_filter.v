...
module pi_loop_filter #(
    ...
    // combinational wires for the shifted values
    ...
    // clock the shifted values into the pipeline registers
    ...
    // pipelined terms for integration and output
    ...
    always @(posedge clk or posedge rst) begin 
        ...
        else if (ctrl_next_limited < -32767) 
            ctrl_word <= -16'sd32767;        
        else
